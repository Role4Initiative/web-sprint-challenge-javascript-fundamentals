...
console.log("Task 1 = Answer: The nested function 'nestedFunction' can access the variable 'const internal' because the variable is in the higher function 'myFunction and variables can be used up and out of the function")
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    ...
    array.map(function(item){
      lowerAni.push(item.animal_name.toLowerCase());
    })
    return lowerAni;
  }
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPopAni = array.filter(function(item){
...
console.log('Topic 2 - Request 3 =', lowPopulationAnimals(zooAnimals));
  ...
  */
  ...
  console.log('Callbacks Step 1 =', consume(2, 5, add));
 
  
  /* 🦁🦁🦁 Step 2: Create several functions to callback with consume(); 🦁🦁🦁 */
 // 🦁🦁🦁 Use add to return the sum of two numbers 🦁🦁🦁
  
  function add(func1CB, func2CB){
    return func1CB + func2CB;
  }

  console.log(add(func1, func2))

// 🦁🦁🦁 Use multiply to return the product of two numbers 🦁🦁🦁
  
function multiply(func1CB, func2CB){
  return func1CB * func2CB;
}

console.log(multiply(func1, func2))
